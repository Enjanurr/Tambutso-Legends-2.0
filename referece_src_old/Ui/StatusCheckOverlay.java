...
public class StatusCheckOverlay {
    ...
    private static final int REQUIRED_PASSENGERS = 6;
    private static final int REQUIRED_FARE = 500;
    ...
    public boolean open(int passengersDropped, int totalFare) {
        ...
        // Check requirements
        passed = (passengersDropped >= REQUIRED_PASSENGERS) && (totalFare >= REQUIRED_FARE);
        ...
        System.out.println("[StatusCheck] Opened - Passengers: " + passengersDropped + "/" + REQUIRED_PASSENGERS +
                ", Fare: " + totalFare + "/" + REQUIRED_FARE + " - " + (passed ? "PASSED" : "FAILED"));
    ...
    private void drawStatsText(Graphics2D g2d, int imgX, int imgY, int imgW, int imgH) {
        ...
        String passengerText = passengersDropped + " / " + REQUIRED_PASSENGERS ;
        ...
        String fareText =  totalFare + " / " + REQUIRED_FARE;
