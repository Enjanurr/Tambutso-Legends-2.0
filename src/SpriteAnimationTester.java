...
public class SpriteAnimationTester extends JPanel implements Runnable {
    ...
    private static final String SPRITE_PATH  = "/change_button.png"; // ← ADJUST: path to sprite sheet
    private static final int    FRAME_WIDTH  = 142;   // ← ADJUST: width of each frame
    ...
    private static final int    ROWS         = 1;    // ← ADJUST: rows in the sheet
