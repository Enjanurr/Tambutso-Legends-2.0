...
import Ui.text.*;
import Ui.audio.*;
import entities.managers.EnemyManager;
import entities.managers.PassengerManager;
import entities.actors.Person;
import entities.managers.PersonManager;
import entities.actors.Player;
import entities.managers.PowerupManager;
import entities.actors.RidingPassenger;
import Ui.overlays.DeathOverlay;
import Ui.hud.HealthBar;
import Ui.hud.PassengerCounter;
import Ui.overlays.PauseOverlay;
import Ui.hud.ProgressBar;
...
public class Playing extends State implements StateMethods {
    ...
    private entities.profile.DriverProfile currentDriver = null;
    ...
    public void applyDriver(entities.profile.DriverProfile profile) {
    ...
    public entities.profile.DriverProfile getCurrentDriver() { return currentDriver; }
