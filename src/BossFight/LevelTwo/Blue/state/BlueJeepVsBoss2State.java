package BossFight.LevelTwo.Blue.state;

import BossFight.LevelTwo.Blue.entity.*;
import BossFight.LevelTwo.Blue.overlay.*;
import BossFight.LevelTwo.Blue.projectile.*;
...
public class BlueJeepVsBoss2State extends State implements StateMethods {
    ...
    public BlueJeepVsBoss2State(Game game, Player player, HealthBar healthBar) {
        ...
        pauseButton = new PauseOverlayButton(pauseBtnX, pauseBtnY, pauseBtnScale, () -> {
            paused = true;
            System.out.println("[BlueJeepVsBoss2] Pause button clicked");
        });
        buildDeathOverlay();
        buildDefeatOverlay();
