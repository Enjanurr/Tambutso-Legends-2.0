package BossFight.LevelTwo.Green.entity;
...
public class Boss2 {
    ...
    private void loadFrames() {
        ...
        System.out.println("Boss 2 Green loaded");
        if (sheet == null) {
    ...
    private void enterSkill1() {
        ...
        skill1Firing = false;
        skill1TargetY = y;
        System.out.println("[Boss2 Green] 💥 Entering SKILL1 (Shoot) phase!");
    }
    ...
    private void enterSkill2() {
        ...
        skill2Phase = 0;
        currentRow = ROW_SKILL2;
        System.out.println("[Boss2 Green] 💧 Entering SKILL2 (Nuke) phase!");
    }
    ...
    public void triggerHit() {
        ...
        aniIndex = 0;
        aniTick = 0;
        System.out.println("[Boss2 Green] 💥 Hit!");
    }
