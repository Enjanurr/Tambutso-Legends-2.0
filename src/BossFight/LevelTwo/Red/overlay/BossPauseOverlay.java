package BossFight.LevelTwo.Red.overlay;

import BossFight.LevelTwo.Red.state.*;
...
public class BossPauseOverlay {
    ...
    private final RedJeepVsBoss2State redJeepVsBoss1State;
    ...
    public BossPauseOverlay(RedJeepVsBoss2State blueJeepVsBoss1State) {
    ...
    public void mouseReleased(MouseEvent e) {
        if (isIn(e, musicButton)) {
            ...
            if (menuBtn.isMousePressed()) {
                ...
                redJeepVsBoss1State.getPlayer().setBossMode(false);  // Reset boss mode
                redJeepVsBoss1State.getGame().setLastActiveGameState(GameStates.RED_JEEP_VS_BOSS2);
