package BossFight.LevelTwo.Red.state;

import BossFight.LevelTwo.Red.entity.*;
import BossFight.LevelTwo.Red.overlay.*;
import BossFight.LevelTwo.Red.projectile.*;
...
public class RedJeepVsBoss2State extends State implements StateMethods {
    ...
    public RedJeepVsBoss2State(Game game, Player player, HealthBar healthBar) {
        ...
        pauseButton = new PauseOverlayButton(pauseBtnX, pauseBtnY, pauseBtnScale, () -> {
            paused = true;
            System.out.println("[RedJeepVsBoss2] Pause button clicked");
        });
        buildDeathOverlay();
        buildDefeatOverlay();
