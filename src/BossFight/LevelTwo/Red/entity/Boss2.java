package BossFight.LevelTwo.Red.entity;

import BossFight.LevelTwo.shared.NukeProjectile;
import main.Game;
...
public class Boss2 {
    ...
    private void loadFrames() {
        ...
        System.out.println("Boss 2 Red loaded");
        if (sheet == null) {
    ...
    private void updateStunState() {
        ...
        if (stunTick >= STUN_DURATION) {
            ...
            aniIndex = 0;
            currentRow = ROW_RUNNING;
            System.out.println("[Boss2 Red] Stun ended");
        }
    }
    ...
    private void enterRandom() {
        boolean useSkill1 = rng.nextBoolean();

        if (useSkill1) {
            System.out.println("[Boss2 Red] 🎲 50/50: Chose SKILL1 (Bullets)");
            enterSkill1();
        } else {
            System.out.println("[Boss2 Red] 🎲 50/50: Chose SKILL2 (Stun Nukes)");
            enterSkill2();
        }
    }
    ...
    private void enterSkill1() {
        ...
        skill1Firing = false;
        skill1TargetY = y;
        System.out.println("[Boss2 Red] 💥 Entering SKILL1 (Shoot) phase!");
    }
    ...
    private void enterSkill2() {
        ...
        skill2Phase = 0;
        currentRow = ROW_SKILL2;
        System.out.println("[Boss2 Red] 💧 Entering SKILL2 (Stun Nuke) phase!");
    }

    private void enterWait() {
        state = BossState.WAIT_AFTER_SKILL;
        stateTick = 0;
        System.out.println("[Boss2 Red] ⏸️ Wait state - preparing next skill");
    }
    ...
    public void triggerHit() {
        ...
        aniIndex = 0;
        aniTick = 0;
        System.out.println("[Boss2 Red] 💥 Hit!");
    }
