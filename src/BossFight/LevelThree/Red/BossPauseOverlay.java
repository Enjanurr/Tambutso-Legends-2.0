...
public class BossPauseOverlay {
    ...
    private final BossFight.LevelThree.Red.RedJeepVsBoss3State redJeepVsBoss3State;
    ...
    public BossPauseOverlay(BossFight.LevelThree.Red.RedJeepVsBoss3State redJeepVsBoss3State) {
