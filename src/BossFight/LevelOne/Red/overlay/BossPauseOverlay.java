package BossFight.LevelOne.Red.overlay;

import BossFight.LevelOne.Red.state.*;
    ...
    public void mouseReleased(MouseEvent e) {
        if (isIn(e, musicButton)) {
            ...
            if (menuBtn.isMousePressed()) {
                ...
                redJeepVsBoss1State.getGame().setLastActiveGameState(GameStates.RED_JEEP_VS_BOSS1);
