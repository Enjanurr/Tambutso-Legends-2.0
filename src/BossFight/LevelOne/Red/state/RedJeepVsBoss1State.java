package BossFight.LevelOne.Red.state;

import BossFight.LevelOne.Red.entity.*;
import BossFight.LevelOne.Red.overlay.*;
import BossFight.LevelOne.Red.projectile.*;
...
public class RedJeepVsBoss1State extends State implements StateMethods {
    ...
    public RedJeepVsBoss1State(Game game, Player player, HealthBar healthBar) {
        ...
        obstacleManager = new BossObstacleManager(game);  // ← ADD THIS
