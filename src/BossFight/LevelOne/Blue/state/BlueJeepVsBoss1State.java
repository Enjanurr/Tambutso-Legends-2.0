package BossFight.LevelOne.Blue.state;

import BossFight.LevelOne.Blue.entity.*;
import BossFight.LevelOne.Blue.overlay.*;
import BossFight.LevelOne.Blue.projectile.*;
...
// Change loadAssets() signature to accept a parameter
    ...
    // Check obstacle collision with player
        ...
        public void mousePressed(MouseEvent e) {
            ...
            } else {skillButtons.mousePressed(e);
            }
        }
    }
        @Override
        ...
        public void mouseMoved(MouseEvent e) {
            ...
            } else {if (pauseButton != null) pauseButton.mouseMoved(e);
