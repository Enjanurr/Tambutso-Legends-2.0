package BossFight.LevelOne.Blue.overlay;

import BossFight.LevelOne.Blue.state.*;
    ...
    public void mouseReleased(MouseEvent e) {
        if (isIn(e, musicButton)) {
            ...
            if (menuBtn.isMousePressed()) {
                ...
                blueJeepVsBoss1State.getPlayer().setBossMode(false);  // Reset boss mode
                blueJeepVsBoss1State.getGame().setLastActiveGameState(GameStates.BLUE_JEEP_VS_BOSS1);
